...
* @route '/locations'
*/
const Controller4420dcf8aa0401dd2e787b7842100090 = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller4420dcf8aa0401dd2e787b7842100090.url(options),
    method: 'get',
})

Controller4420dcf8aa0401dd2e787b7842100090.definition = {
    methods: ["get","head"],
    url: '/locations',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/locations'
*/
Controller4420dcf8aa0401dd2e787b7842100090.url = (options?: RouteQueryOptions) => {
    return Controller4420dcf8aa0401dd2e787b7842100090.definition.url + queryParams(options)
}
...
* @route '/locations'
*/
Controller4420dcf8aa0401dd2e787b7842100090.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller4420dcf8aa0401dd2e787b7842100090.url(options),
    method: 'get',
})
...
* @route '/locations'
*/
Controller4420dcf8aa0401dd2e787b7842100090.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: Controller4420dcf8aa0401dd2e787b7842100090.url(options),
    method: 'head',
})
...
* @route '/locations'
*/
const Controller4420dcf8aa0401dd2e787b7842100090Form = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller4420dcf8aa0401dd2e787b7842100090.url(options),
    method: 'get',
})
...
* @route '/locations'
*/
Controller4420dcf8aa0401dd2e787b7842100090Form.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller4420dcf8aa0401dd2e787b7842100090.url(options),
    method: 'get',
})
...
* @route '/locations'
*/
Controller4420dcf8aa0401dd2e787b7842100090Form.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller4420dcf8aa0401dd2e787b7842100090.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
Controller4420dcf8aa0401dd2e787b7842100090.form = Controller4420dcf8aa0401dd2e787b7842100090Form
/**
* @see \Inertia\Controller::__invoke
* @see vendor/inertiajs/inertia-laravel/src/Controller.php:13
* @route '/dashboard'
...
const Controller = {
    ...
    '/locations': Controller4420dcf8aa0401dd2e787b7842100090,
